                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12">
                            <fieldset class="form-group">
                                <label class="form-label semibold" for="cat_nom">Título</label>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <fieldset class="form-group">
                                ...
                                <div class="summernote-theme-1">
                                    <textarea id="tickd_descrip" name="tick_descrip" class="summernote"
                                        name="name"></textarea>
                                </div>
                            </fieldset>
                        </div>
                        ...
                        <div class="col-lg-12">
                            <button type="button" id="btnenviar"
                                class="btn btn-rounded btn-inline btn-primary">Enviar</button>
